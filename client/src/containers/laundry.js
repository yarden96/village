            ...
            <div>
                <div className="laundry-right">
                    <div className="laundry-right-right">
                        <select name="laundry" className="input" onChange={this.renderScheduleTable} selected={this.state.laundry}>
                    ...
                    <div className="laundry-right-left">
                        <select name="dryer" className="input" onChange={this.renderScheduleTable} selected={this.state.dryer}>
                            <option>Dryer</option>
